...
from tests.w2w_rome.base import BaseRomeTestCase, CliEmulator, Command, \
    ...
    PORT_SHOW_MATRIX_Q128_1, PORT_SHOW_MATRIX_Q128_2, PORT_SHOW_MATRIX_A_CHANGED_PORT, \
    PORT_SHOW_MATRIX_XY, PORT_SHOW_MATRIX_XY_CHANGED_PORT, \
...
'''
    ...
    def test_map_clear_matrix_xy_changed_port(self):
        ...
        disconnected_port_show_xy = set_port_disconnected('E2', PORT_SHOW_MATRIX_XY_CHANGED_PORT)
        disconnected_port_show_xy = set_port_disconnected(
